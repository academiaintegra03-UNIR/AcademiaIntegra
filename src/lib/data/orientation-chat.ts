...
export const orientationGreeting =
  "¡Hola! Soy Álex, el asistente de orientación de Nova Digital Systems. Puedo ayudarte a ubicar el programa adecuado o resolver dudas rápidas sobre matrícula. ¿En qué te puedo ayudar?";
